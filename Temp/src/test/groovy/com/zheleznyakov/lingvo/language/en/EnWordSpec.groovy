...
class EnWordSpec extends Specification {
    ...
    @Unroll
    def "Test com.zheleznyakov.lingvo.basic properties of simple English parts of speech -- #expectedPartOfSpeech -- #word"() {
        when: "an English word is created"
        EnWord enWord = builder(word)

        then: "all its com.zheleznyakov.lingvo.basic properties are correct"
        with(enWord) {
    ...
    @Unroll
    def "Test com.zheleznyakov.lingvo.basic properties of complex English parts of speech -- #expectedPartOfSpeect -- #word"() {
        when: "an English word is created"
        EnWord enWord = builder(word)
