...
import com.zheleznyakov.lingvo.fx.controllers.MainPageController;
import com.zheleznyakov.lingvo.fx.nodes.panes.ChoosePane;
...
public class UiFxMain extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        chooseLanguagePane = new ChoosePane<>("Choose language:", Language.values(), Config.DEFAULT_LANGUAGE);
