...
import com.zheleznyakov.lingvo.fx.nodes.buttons.UpButton;
import com.zheleznyakov.lingvo.fx.nodes.buttons.BackButton;
import com.zheleznyakov.lingvo.fx.nodes.buttons.DownButton;
import com.zheleznyakov.lingvo.fx.nodes.buttons.MinusButton;
import com.zheleznyakov.lingvo.fx.nodes.buttons.PlusButton;
...
public class DictionaryPane extends BorderPane {
    ...
    private void ensureDictionaryForThisLanguage() throws IOException, ClassNotFoundException {
        String fileName = language.toLowerCase() + PersistenceManager.DIC_EXTENSION;
...
//    }
    ...
    private void setUpLayout() {
        ...
        buttonBox.setSpacing(Config.MIN_SPACE);
        buttonBox.setAlignment(Pos.CENTER_RIGHT);

        HBox contentAndControlBox = new HBox(Config.MIN_SPACE);
